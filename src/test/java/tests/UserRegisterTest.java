...
public class UserRegisterTest extends BaseTestCase {
    ...
    public void testCreateUserWithLongName() {
        ...
        assertResponseTextEquals(response, "The value of 'firstName' field is too long");
        assertResponseCodeEquals(response, 400);
    }
